...
<html lang="en" style="height: 100%">
    <head>
        <meta charset="utf-8">
        <title>pdfsplitter.py : /home/jcallejas/mysite/Flask-Pdf-Splitter--master/pdfsplitter.py : Editor : jcallejas : PythonAnywhere</title>
        <meta name="viewport" content="width=device-width, initial-scale=1.0">
        <meta name="description" content="pdfsplitter.py : /home/jcallejas/mysite/Flask-Pdf-Splitter--master/pdfsplitter.py : Editor : jcallejas : PythonAnywhere">
        ...
        <script type="text/javascript">
            var Anywhere = {};
            Anywhere.urls = {};
            Anywhere.csrfToken = "vIVBfWPpZLcGFIELT1woR7r0bT6n3c8Ur7H7SWRki9wQlg0KfD4JT5ZU5lwwpbIQ";
        </script>
    ...
    <script type="text/javascript">
      $(document).ready(function() {
        $.extend(Anywhere.urls, {
          file: "/user/jcallejas/files/home/jcallejas/mysite/Flask-Pdf-Splitter--master/pdfsplitter.py",
          check_hash: "/user/jcallejas/files/home/jcallejas/mysite/Flask-Pdf-Splitter--master/pdfsplitter.py",
        ...
        var filename = "/home/jcallejas/mysite/Flask\u002DPdf\u002DSplitter\u002D\u002Dmaster/pdfsplitter.py";
        var hash = "f3276e25fee714bd555bca09a0876977";
        ...
        Anywhere2.initializeFileSharingOptions(
          $('#id_file_sharing_options')[0],
          {
            ...
            csrfToken: "vIVBfWPpZLcGFIELT1woR7r0bT6n3c8Ur7H7SWRki9wQlg0KfD4JT5ZU5lwwpbIQ",
            path: "/home/jcallejas/mysite/Flask\u002DPdf\u002DSplitter\u002D\u002Dmaster/pdfsplitter.py"
          }
        );
...
<li class=""><a href="https://blog.pythonanywhere.com/" class="blog_link">Blog</a></li>
  ...
  <li class="">
    <form action="/logout/" method="POST">
      <input type="hidden" name="csrfmiddlewaretoken" value="vIVBfWPpZLcGFIELT1woR7r0bT6n3c8Ur7H7SWRki9wQlg0KfD4JT5ZU5lwwpbIQ">
  ...
  <div>
    <div id="id_ide_split_panes">
        ...
        <div id="id_editor">from PyPDF2 import PdfFileWriter,PdfFileReader
